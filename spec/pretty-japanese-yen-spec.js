describe("prettyJapaneseYen", function() {
  ...
  it("sets the correct unit", function() {
    expect(prettyJapaneseYen(500, "枚")).toEqual("500枚");
    expect(prettyJapaneseYen(1000, "枚")).toEqual("1千枚");
    expect(prettyJapaneseYen(10000, "枚")).toEqual("1万枚");
    expect(prettyJapaneseYen(100000000, "枚")).toEqual("1億枚");
    expect(prettyJapaneseYen(10000000000, "枚")).toEqual("100億枚");
  });
});
